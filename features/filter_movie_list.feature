...
Scenario: restrict to movies with 'PG' or 'R' ratings
  ...
  And I press "Refresh"
  Then I should see the following films: "The Terminator, When Harry Met Sally, Amelie, The Incredibles, Raiders of the Lost Ark"
  And I should not see the following films: "Aladdin, The Help, Chocolat, 2001: A Space Odyssey, Chicken Run"
